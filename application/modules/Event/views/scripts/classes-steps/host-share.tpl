...
<div class="classes-steps-host-share-content" id="classes-steps-host-share-content">
  <h3 class="title">
    <span class="main"><?php echo $this->translate('CLASSES_STEP_HOST_SHARE_TITLE'); ?></span>
    <span class="more"><?php echo $this->translate('CLASSES_STEP_HOST_SHARE_TITLE_MORE'); ?></span>
  </h3>
  <div class="description">
    <?php echo nl2br($this->translate('CLASSES_STEP_HOST_SHARE_DESCRIPTION')); ?>
  </div>
...
<script>
  stWidget.addEntry({
    ...
    "title":'<?php echo $this->translate('SHARED_HOST_TITLE_FACEBOOK'); ?>',
    "type":"custom",
...
<script>
  stWidget.addEntry({
    ...
    "url":'<?php echo Engine_Api::_()->event()->getSiteUrl() . $this->url(array('id' => $this->eventId), 'event_profile'); ?>',
    "title":'<?php echo $this->translate('SHARED_HOST_TITLE_TWITTER'); ?>',
    "type":"custom",
  ...
  stWidget.addEntry({
    ...
    "url": "<?php echo addslashes($this->translate('SHARED_HOST_TEXT_EMAIL %s', $url)); ?>",
    "title":'<?php echo $this->translate('SHARED_HOST_TITLE_EMAIL'); ?>',
    "type":"custom",
