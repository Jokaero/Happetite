...
class Messages_Model_DbTable_Conversations extends Engine_Db_Table
{
  ...
  public function send(Core_Model_Item_Abstract $user, $recipients, $title, $body, $attachment = null, $system = false)
  {
    $resource = null;
    ...
    $conversation->setFromArray(array(
      ...
      'locked' => ($system ? true : ( $resource ? true : false )),
