...
<div>
    ...
    <?php else: ?>
        ...
        <span>
          <?php echo '<div class="tip"><span>No plugins by YouNet Development were found on your site. Click <a href="http://socialengine.younetco.com" target="_blank">here</a> to view and purchase them.</span></div>'; ?>
        </span>
