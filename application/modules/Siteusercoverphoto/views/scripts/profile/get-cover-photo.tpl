...
<?php $user_level_id = isset($this->user->level_id) ? $this->user->level_id : 'no-viewer'; ?>
	...
	<?php if (!empty($this->can_edit)) : ?>
		<div id="siteusercoverphoto_cover_options" class="seaocore_profile_cover_options <?php if (empty($this->user->user_cover) || empty($this->photo)) : ?> dblock <?php endif; ?>">
			<ul class="edit-button">
				<li>
					<?php if ($this->event) : ?>
						<?php if (!empty($this->event->user_cover) && $this->photo) : ?>
					...
					<ul class="seaocore_profile_options_pulldown">
						<li>
							<a href='<?php echo $this->url(array(
								 ...
								 class="seaocore_profile_cover_icon_photo_upload smoothbox"><?php echo $this->translate('Upload Cover Photo'); ?></a>
						</li>
						<?php if (false) : ?>
							<li>
							...
							<?php if (!empty($this->event->user_cover) && $this->photo) : ?>
								...
								<li>
									<?php echo $this->htmlLink(array(
										'route' => 'siteusercoverphoto_profilepage',
										'action' => 'remove-cover-photo',
										'user_id' => $this->user->user_id,
										'subject' => get_class($this->subject()),
										'subject_id' => $this->subject()->getIdentity(),
									), $this->translate('Remove Cover Photo'),
										 array(' class' => 'smoothbox seaocore_profile_cover_icon_photo_delete')); ?>
								</li>
							<?php endif; ?>
						<?php else : ?>
							<?php if (!empty($this->user->user_cover) && $this->photo) : ?>
			...
			<?php if ($this->event) : ?>
				<?php if (!empty($this->event->user_cover)) : ?>
