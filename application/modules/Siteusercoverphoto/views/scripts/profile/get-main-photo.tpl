    ...
    <?php if (empty($this->cover_photo_preview)): ?>
      <div class="seaocore_profile_coverinfo_status">
        <?php if (in_array('title', $this->showContent)): ?>
          <div class="fleft"><a href="<?php echo $this->user->getHref(); ?>"><h2 style="color:<?php echo $this->fontcolor; ?>"><?php echo $this->user->getTitle(); ?></h2></a></div>
        <?php endif; ?>
        
          <?php $siteverifyModule = Engine_Api::_()->getDbtable('modules', 'core')->getModule('siteverify'); ?>
        <?php if ($siteverifyModule): ?>
        ...
        <?php if (in_array('rating', $this->showContent)): ?>
          <?php $sitememberModule = Engine_Api::_()->getDbtable('modules', 'core')->getModule('sitemember'); ?>
          <?php if ($sitememberModule && !empty($sitememberModule->enabled)) : ?>
            <div class="mtop5"> 
