...
<div class="user_profile_info_wrapper">
  ...
  <?php // Event Owner ?>
  <div class="event_owner_wrapper">
    <?php echo $this->content()->renderWidget('event.event-owner'); ?>
  </div>
  
  <?php // User Profile Fields ?>
  <div class="user_profile_fields_wrapper">
    <?php echo $this->content()->renderWidget('user.profile-fields'); ?>
  </div>
  
  <?php // User Profile Options ?>
