...
class Seaocore_Form_Admin_Settings extends Engine_Form
{
    ...
    $this->addElement('Radio', 'seaocore_calendar_daystart', array(
        ...
        'multiOptions' => array(
            0 => 'First day of week as Sunday, and last as Saturday',
            1 => 'First day of week as Monday, and last as Sunday',
            6 => 'First day of week as Saturday, and last as Friday'
        ),
        'value' => Engine_Api::_()->getApi('settings', 'core')->getSetting('seaocore.calendar.daystart', 0),
    ));    
