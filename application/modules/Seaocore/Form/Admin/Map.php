...
class Seaocore_Form_Admin_Map extends Engine_Form
{
    ...
    if(Engine_Api::_()->seaocore()->getLocationsTabs()) {
        ...
        $this->addElement('Radio', 'seaocore_locationspecific', array(
            ...
            'description' => 'Do you want to enable specific locations functionality. If you select "Yes", then user`s can filter the content according to the locations added by you. You can add specific locations from "Manage Locations" sections.',
