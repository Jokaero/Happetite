        ...
        <table class='admin_table seaocore_admin_table' width="100%">
            <thead>
                <tr>
                    ...
                    <th class="<?php echo $class ?>" ><a href="javascript:void(0);" onclick="javascript:changeOrder('locationcontent_id', 'DESC');"><?php echo 'ID'; ?></a></th>

                    <?php $class = ( $this->order == 'title' ? 'admin_table_ordering admin_table_direction_' . strtolower($this->order_direction) : '' ) ?>
                    <th style="width:25%" class="<?php echo $class ?>"  align="left"><a href="javascript:void(0);" onclick="javascript:changeOrder('title', 'ASC');"><?php echo 'Title'; ?></a></th>
                    
                    <?php $class = ( $this->order == 'location' ? 'admin_table_ordering admin_table_direction_' . strtolower($this->order_direction) : '' ) ?>
                                        <th class="<?php echo $class ?>"  align="left"><a href="javascript:void(0);" onclick="javascript:changeOrder('location', 'ASC');"><?php echo 'Location'; ?></a></th>                    
                    
                    <?php $class = ( $this->order == 'status' ? 'admin_table_ordering admin_table_direction_' . strtolower($this->order_direction) : '' ) ?>
                    <th class="<?php echo $class ?> admin_table_centered" title="<?php echo 'Status'; ?>"><a href="javascript:void(0);" onclick="javascript:changeOrder('status', 'ASC');"><?php echo 'Status'; ?></a></th>                  
    
                    <th style="width:6%" class="<?php echo $class ?>"  class='admin_table_centered'><?php echo 'Options'; ?></th>
                </tr>
            </thead>
