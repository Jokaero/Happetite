  ...
  <div class="admin_seaocore_guidelines_wrapper">
    <ul class="admin_seaocore_guidelines" id="guideline_1">
			<li>
               ...
               <?php echo $this->translate("2) Go to this URL for steps to configure Linkedin Integration on your SocialEngine website : ");?><a href="http://www.youtube.com/watch?v=_jQN9Gw0Xx8 
" target="_blank" style="color:#5BA1CD;">http://www.youtube.com/watch?v=_jQN9Gw0Xx8</a><br/>
