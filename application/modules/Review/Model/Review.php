...
class Review_Model_Review extends Core_Model_Item_Abstract
{
  ...
  public function canUserDelete($viewer)
  {
    $revieweedelete = Engine_Api::_()->getApi('settings', 'core')->getSetting('review.revieweedelete', 0);
    $allowdelete = $revieweedelete && $this->isUser($viewer);
    return $allowdelete;
  }
}