  ...
  public function addHomePage()
  {
    ...
    if( empty($info) ) {
      ...
      $db->insert('engine4_core_content', array(
        ...
        'order' => $i++,
        'params' => '{"title":"Top Rated Members","max":5,"showphoto":1,"showstars":1,"showdetails":1}',
      ));  
      $db->insert('engine4_core_content', array(
        'page_id' => $page_id,
        'type' => 'widget',
        ...
        'parent_content_id' => $main_left_id,
        'order' => $i++,
        'params' => '{"title":"Most Recommended","max":5,"showphoto":1,"showstars":1,"showdetails":1}',
      )); 
      $db->insert('engine4_core_content', array(
        'page_id' => $page_id,
        'type' => 'widget',
        ...
        'parent_content_id' => $main_left_id,
        'order' => $i++,
        'params' => '{"title":"Most Reviewed","max":5,"showphoto":1,"showstars":1,"showdetails":1}',
      ));      
      // ------ MAIN :: RIGHT WIDGETS
      $db->insert('engine4_core_content', array(
        'page_id' => $page_id,
      ...
      $db->insert('engine4_core_content', array(
        ...
        'parent_content_id' => $main_right_id,
        'order' => $i++,
        'params' => '{"title":"Review Statistics"}',
      ));
      $db->insert('engine4_core_content', array(
        'page_id' => $page_id,
        'type' => 'widget',
        ...
        'parent_content_id' => $main_right_id,
        'order' => $i++,
        'params' => '{"title":"Top Reviewers","max":5,"showphoto":1,"showdetails":1}',
      ));
      // ------ MAIN :: MIDDLE WIDGETS   
      $db->insert('engine4_core_content', array(
        'page_id' => $page_id,
