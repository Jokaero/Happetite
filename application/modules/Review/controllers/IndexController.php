...
class Review_IndexController extends Core_Controller_Action_Standard
{
  ...
  {
    if (!Engine_Api::_()->radcodes()->validateLicense('review')) {
      return $this->_redirectCustom(array('route'=>'radcodes_general', 'action'=>'license', 'type'=>'review'));
    }
  ...
  public function deleteAction()
  {
    ...
    if( !$review->authorization()->isAllowed($viewer, 'delete') && !$review->canUserDelete($viewer)) {
      return $this->_forward('requireauth', 'error', 'core');
    }    
