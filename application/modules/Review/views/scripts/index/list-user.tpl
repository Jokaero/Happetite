...
<div class='layout_middle review_layout_middle'>
  <div class='review_list'>
          ...
          <li<?php if ($review->featured):?> class="review_featured_entry"<?php endif;?>>
            ...
            <div class="review_info">
              ...
              <div class="review_info_meta">
                ...
                <?php if ($review->canUserDelete($this->viewer())): ?>
                - <?php echo $this->htmlLink($review->getDeleteHref(), $this->translate('Delete Review'), array('class'=>'review_meta_delete'))?>
                <?php endif; ?>
              </div>
    ...
    <?php elseif( $this->rating || $this->keyword || $this->recommend):?>
      <div class="tip">
        <span>
