...
<?php if ($this->current_count >= $this->quota && $this->quota > 0):?>
  ...
  <br/>
<?php else:?>
  <div class="form-outer-title"><?php echo $this->translate('Post New Review'); ?></div>
  <div class="form-outer-description"><?php echo $this->translate('Compose your new review below, then click "Post Review" to publish the review.'); ?></div>
