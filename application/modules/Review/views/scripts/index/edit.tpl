...
<div class="form-outer-title"><?php echo $this->translate('Edit Review'); ?></div>
<div class="form-outer-description"><?php echo $this->translate('Edit your review below, then click "Save Changes" to save your review.'); ?></div>
